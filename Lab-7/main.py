...
def main():
    ...
    ukraine = Country("Ukraine", "Kyiv", "UA", '1231313123', "603500", 1311.29, GovernmentType.DEMOCRACY)
    poland = Country(2, 1, 212, 38000000, 312696, 614.86, GovernmentType.REPUBLIC)
    france = Country("France", "Paris", "FR", 68000000, 551695, 2958, GovernmentType.REPUBLIC)
